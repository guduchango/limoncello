...
use \App\Http\Controllers\Repositories\PricelistRepo;

class PricelistsController extends JsonApiController
{
    protected $allowedFilteringParameters = ['ids'];

    protected $repository;

    public function __construct(PricelistRepo $repository){
